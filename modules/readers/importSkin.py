...
def importSkin(skinName: str, defaultSkinURL: str, osuURL: str, directSkinURL: bool = False) -> dict:
  if directSkinURL:
    skinURL = os.path.abspath(skinName)
  else:
    print(f'checking for folder {osuURL}')
    ...
    skinURL = os.path.abspath(os.path.join(osuURL, 'Skins', skinName))

  defaultSkinURL = os.path.abspath(defaultSkinURL)

  print(f'checking for folder {skinURL}')
